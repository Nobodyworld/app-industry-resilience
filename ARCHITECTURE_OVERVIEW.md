...
- **Documentation** in `docs/ARCHITECTURE_OVERVIEW.md` expands on the module responsibilities, observability strategy, incident response flow, and future-proofing notes. Use it alongside `AUTOMATION.md`, `EXTENSION_GUIDE.md`, and `docs/OPERATIONS_INCIDENT_RESPONSE.md` when onboarding new contributors or agents.

For detailed diagrams, connector health semantics, and extension recipes, read [docs/ARCHITECTURE_OVERVIEW.md](docs/ARCHITECTURE_OVERVIEW.md).
