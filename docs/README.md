...
- `exec/` – executive summaries and reports used for stakeholder updates.
- `execplans/` – historical execution plans that describe past upgrade or restructuring efforts.
...
- [DEPLOYMENT_STREAMLIT_COMMUNITY_CLOUD.md](DEPLOYMENT_STREAMLIT_COMMUNITY_CLOUD.md) – public Streamlit Community Cloud deployment contract, hosted acceptance, and rollback guidance.
