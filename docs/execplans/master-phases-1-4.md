...
3. **Docs & stewardship artefacts** – Update `docs/handbook/EXTENSION_GUIDE.md`, `docs/handbook/AUTOMATION.md`, `README.md`, `docs/OBSERVABILITY_SNAPSHOTS.md`, and `docs/OPERATIONS_INCIDENT_RESPONSE.md` as needed to explain automatic snapshot persistence, retention knobs, and the new extension. Refresh `CHANGELOG.md`, `docs/handbook/RELEASE_NOTES.md`, `docs/handbook/STATUS.md`, and `docs/handbook/STEWARDS_REPORT.md` with the new feature summary, upgrade notes, updated metrics (using `python scripts/audit_metrics.py --runs 3`), and revised roadmap items.
...
3. Refresh documentation (`README.md`, `docs/OBSERVABILITY_SNAPSHOTS.md`, `docs/handbook/EXTENSION_GUIDE.md`, `docs/handbook/AUTOMATION.md`, `docs/handbook/STATUS.md`, `CHANGELOG.md`, `docs/handbook/RELEASE_NOTES.md`, `docs/handbook/STEWARDS_REPORT.md`) to describe the new automation, metrics, and roadmap adjustments.
