...
- Link updated onboarding docs for future contributors: [README.md](../README.md), [ARCHITECTURE.md](handbook/ARCHITECTURE.md), and [docs/AI_INTERFACE.md](AI_INTERFACE.md).
