...
- [ ] Increase test coverage from 80% to sustained runtime-gate compliance and improved full-source trend | owner: dev | priority: high | added: 2025-11-14 – Progress: added integration, streamlit, security, and cache tests to improve coverage; remaining work: add UI smoke tests, observability replication tests, and adapter edge-case branches.
