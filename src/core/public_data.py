...
DEFAULT_PUBLIC_DATASETS: tuple[DatasetDefinition, ...] = (
    ...
    DatasetDefinition(
        dataset_id="census_asm_annual",
        name="Annual Survey of Manufactures",
        agency="U.S. Census Bureau",
        endpoint="https://api.census.gov/data/{year}/asm",
        update_cadence="annual",
        frequency="annual",
        observation_period="Survey year",
        release_period="Annual Census ASM release year",
        units="Source-native Census API monetary values",
        historical_coverage="Historical annual manufacturing releases where Census API exposes ASM",
        canonical_schema=DIRECT_INDUSTRY_SCHEMA,
        canonical_field_mappings=DIRECT_INDUSTRY_FIELD_MAPPINGS,
        release_monitor="https://www.census.gov/programs-surveys/asm.html",
    ),
    DatasetDefinition(
