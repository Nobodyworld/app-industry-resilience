...
2. Use the top tabs in order: Overview, Explore, Compare, Scenario Lab, then Industry Pulse.
...
5. Open **Industry Pulse** to inspect exact mapping availability or clearly labeled manual
   browsing, monthly history, freshness, and signal-only CSV/JSON/XLSX downloads.
...
- First-class Industry Pulse tab with exact six-digit mapping, explicit unmapped/manual-browse
  states, monthly chart and table, current/stale disclosure, and separate signal provenance.
